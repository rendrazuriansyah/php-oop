...
// kalo mau destruct disini maka hrs pke unset buat ngedahuluinnya
// minusnya bakal ngempengaruhi urutan destruct di bawah

$senior = new Senior(['total'=>5, 'target'=>3]); // $instanceCount = 3..... dst;
echo "Senior: {$senior->total}, {$senior->target}";
echo "<br>";

// jika tidak ada penggunaan instance lagi, maka akan dijalankan destruct
// dieksekusi pada akhir keseluruhan instance
